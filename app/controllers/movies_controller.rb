class MoviesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie.save
        format.html { redirect_to movie_url(@movie), notice: "Película ha sido Guardada." }
    ...
    if movie_params['client_id'] == '1'
      respond_to do |format|
        if @movie.update(movie_params)
          format.html { redirect_to movie_url(@movie), notice: "Película ha sido devuelta" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to movies_url, notice: "Película ha sido Eliminada." }
